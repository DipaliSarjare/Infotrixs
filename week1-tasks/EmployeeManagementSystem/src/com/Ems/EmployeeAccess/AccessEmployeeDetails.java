package com.Ems.EmployeeAccess;
...
public class AccessEmployeeDetails {
	 private String filePath="C:\\Users\\RAJAT\\Desktop\\week1-tasks\\EmployeeManagementSystem\\src\\employee.txt";

	    public AccessEmployeeDetails(String filePath) {
	    ...
	    private String employeeToFormattedString(Employee employee) {
	        return employee.getId() + "," + employee.getName() + "," + employee.getAge() + "," + employee.getAddress() + ","
